...
public class PdfUaWithSignature2 {

    public static void main(String[] args) throws IOException {
        try (PDDocument document = new PDDocument()) {

            // Set document language and mark as tagged
            ...
            // Write tagged content using manual BDC/EMC with raw commands
            try (PDPageContentStream content = new PDPageContentStream(document, page)) {
                // Begin BDC: /P << /MCID 0 >> BDC
            ...
            // Create widget annotation for the signature field
...
//            widget.setHighlightMode(PDAnnotationHighlightingMode.INVERT);
            ...
            parentTree.setNumbers(nums);
            structureTreeRoot.setParentTree(parentTree);

            // Save document
            document.save("~//Downloads/pdfua_signature_field_2_1.pdf");

            document.save("pdfua_signature_field_2_1.pdf");
            System.out.println("✅ PDF/UA file with signature field created: pdfua_signature_field.pdf");
        }
    }
}
